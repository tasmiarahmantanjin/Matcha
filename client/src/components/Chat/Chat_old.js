...
const Chat = ( { id } ) => {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:5000/conversation', requestOptions0) // Change to chatService.getConversation
        ...
        .then(data =>{
          ...
          fetch('http://localhost:5000/profile', requestOptions2) // Change to chatService.getPartnerProfile - in case user is profile one
              .then(response => response.json())
              .then(data =>{
                //console.log(data.rows) 
          ...
          fetch('http://localhost:5000/profile', requestOptions2) // Change to chatService.getPartnerProfile - in case user is profile two
              .then(response => response.json())
              .then(data =>{
                //console.log(data.rows) 
                setPartner(data.rows[0])
        ...
        fetch('http://localhost:5000/messages', requestOptions1) // Change to chatService.getMessages - in case user is profile one
            .then(response => response.json())
            .then(data =>{
              //console.log(data.rows) 
